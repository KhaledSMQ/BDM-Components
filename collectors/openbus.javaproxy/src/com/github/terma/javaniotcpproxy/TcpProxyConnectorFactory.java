...
class TcpProxyConnectorFactory implements TcpServerHandlerFactory {
    ...
    public TcpProxyConnectorFactory(TcpProxyConfig config, IntegrationQueue integrationQueue) {
        this.config = config;
    ...
    public TcpServerHandler create(final SocketChannel clientChannel) {
        return new TcpProxyConnector(clientChannel, config, integrationQueue);
    }
