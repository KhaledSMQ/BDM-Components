...
public class TcpProxyConfig {
    ...
    private int idlenessTickInterval;
    private int idleClientTimeout;

    public TcpProxyConfig(int localPort, String remoteHost, int remotePort, boolean onlyActiveChecks, String topicName) {
    ...
    public int getIdlenessTickInterval() {
        return idlenessTickInterval;
    }

    public void setIdlenessTickInterval(int idlenessTickInterval) {
        this.idlenessTickInterval = idlenessTickInterval;
    }
    ...
    public void setIdleClientTimeout(int idleClientTimeout) {
