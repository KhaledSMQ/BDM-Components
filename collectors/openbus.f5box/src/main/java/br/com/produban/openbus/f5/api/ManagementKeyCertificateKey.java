...
public class ManagementKeyCertificateKey  implements java.io.Serializable {
    ...
    private ManagementKeyCertificateSecurityType security;
     ...
     * @return security
     */
    public ManagementKeyCertificateSecurityType getSecurity() {
        return security;
    }
     ...
     * @param security
     */
    public void setSecurity(ManagementKeyCertificateSecurityType security) {
        this.security = security;
    }
