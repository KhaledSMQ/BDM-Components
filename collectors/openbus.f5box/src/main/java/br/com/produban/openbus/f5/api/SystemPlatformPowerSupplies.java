...
public class SystemPlatformPowerSupplies  implements java.io.Serializable {
    private SystemPSMetric[][] power_supplies;
     ...
     */
    public SystemPSMetric[][] getPower_supplies() {
        return power_supplies;
    }
     ...
     */
    public void setPower_supplies(SystemPSMetric[][] power_supplies) {
        this.power_supplies = power_supplies;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getPower_supplies() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getPower_supplies(), i);
                if (obj != null &&
