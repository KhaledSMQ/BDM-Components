...
public class SystemDiskUsage  implements java.io.Serializable {
    ...
    private CommonULong64 block_size;

    private CommonULong64 total_blocks;

    private CommonULong64 free_blocks;

    private CommonULong64 total_nodes;

    private CommonULong64 free_nodes;
    ...
    public SystemDiskUsage(
           ...
           CommonULong64 block_size,
           CommonULong64 total_blocks,
           CommonULong64 free_blocks,
           CommonULong64 total_nodes,
           CommonULong64 free_nodes) {
     ...
     * @return block_size
     */
    public CommonULong64 getBlock_size() {
        return block_size;
    }
     ...
     * @param block_size
     */
    public void setBlock_size(CommonULong64 block_size) {
        this.block_size = block_size;
    }
     ...
     * @return total_blocks
     */
    public CommonULong64 getTotal_blocks() {
        return total_blocks;
    }
     ...
     * @param total_blocks
     */
    public void setTotal_blocks(CommonULong64 total_blocks) {
        this.total_blocks = total_blocks;
    }
     ...
     * @return free_blocks
     */
    public CommonULong64 getFree_blocks() {
        return free_blocks;
    }
     ...
     * @param free_blocks
     */
    public void setFree_blocks(CommonULong64 free_blocks) {
        this.free_blocks = free_blocks;
    }
     ...
     * @return total_nodes
     */
    public CommonULong64 getTotal_nodes() {
        return total_nodes;
    }
     ...
     * @param total_nodes
     */
    public void setTotal_nodes(CommonULong64 total_nodes) {
        this.total_nodes = total_nodes;
    }
     ...
     * @return free_nodes
     */
    public CommonULong64 getFree_nodes() {
        return free_nodes;
    }
     ...
     * @param free_nodes
     */
    public void setFree_nodes(CommonULong64 free_nodes) {
        this.free_nodes = free_nodes;
    }
