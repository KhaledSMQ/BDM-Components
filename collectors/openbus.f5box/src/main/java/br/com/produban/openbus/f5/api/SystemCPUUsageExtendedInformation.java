...
public class SystemCPUUsageExtendedInformation  implements java.io.Serializable {
    private SystemCPUUsageExtended[] hosts;
     ...
     * @return hosts
     */
    public SystemCPUUsageExtended[] getHosts() {
        return hosts;
    }
     ...
     * @param hosts
     */
    public void setHosts(SystemCPUUsageExtended[] hosts) {
        this.hosts = hosts;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getHosts() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getHosts(), i);
                if (obj != null &&
