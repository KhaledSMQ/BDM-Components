/**
 * SystemStatisticsGlobalPVAStatistics.java
 *
...
public class SystemStatisticsGlobalPVAStatistics  implements java.io.Serializable {
    private CommonStatistic[] statistics;

    private CommonTimeStamp time_stamp;

    public SystemStatisticsGlobalPVAStatistics() {
    }
    ...
    /**
     * Gets the statistics value for this SystemStatisticsGlobalPVAStatistics.
     * 
     * @return statistics
     */
    ...
    /**
     * Sets the statistics value for this SystemStatisticsGlobalPVAStatistics.
     * 
     * @param statistics
     */
    ...
    /**
     * Gets the time_stamp value for this SystemStatisticsGlobalPVAStatistics.
     * 
     * @return time_stamp
     */
    ...
    /**
     * Sets the time_stamp value for this SystemStatisticsGlobalPVAStatistics.
     * 
     * @param time_stamp
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof SystemStatisticsGlobalPVAStatistics)) return false;
        SystemStatisticsGlobalPVAStatistics other = (SystemStatisticsGlobalPVAStatistics) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SystemStatisticsGlobalPVAStatistics.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:iControl", "System.Statistics.GlobalPVAStatistics"));
