...
public class LocalLBPoolMemberMemberMonitorState  implements java.io.Serializable {
    ...
    private CommonEnabledState monitor_state;
    ...
    public LocalLBPoolMemberMemberMonitorState(
           ...
           CommonEnabledState monitor_state) {
           this.member = member;
     ...
     */
    public CommonEnabledState getMonitor_state() {
        return monitor_state;
    }
     ...
     * @param monitor_state
     */
    public void setMonitor_state(CommonEnabledState monitor_state) {
        this.monitor_state = monitor_state;
    }
