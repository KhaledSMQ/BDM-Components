...
public class SystemFanMetric  implements java.io.Serializable {
    private SystemFanMetricType metric_type;
    ...
    public SystemFanMetric(
           SystemFanMetricType metric_type,
           long value) {
     ...
     * @return metric_type
     */
    public SystemFanMetricType getMetric_type() {
        return metric_type;
    }
     ...
     * @param metric_type
     */
    public void setMetric_type(SystemFanMetricType metric_type) {
        this.metric_type = metric_type;
    }
