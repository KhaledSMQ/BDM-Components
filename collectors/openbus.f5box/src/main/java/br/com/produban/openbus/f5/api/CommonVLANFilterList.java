...
public class CommonVLANFilterList  implements java.io.Serializable {
    private CommonEnabledState state;
     ...
     * @return state
     */
    public CommonEnabledState getState() {
        return state;
    }
     ...
     * @param state
     */
    public void setState(CommonEnabledState state) {
        this.state = state;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getVlans() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getVlans(), i);
                if (obj != null &&
