...
public class LocalLBPoolMemberMemberSessionState  implements java.io.Serializable {
    ...
    private CommonEnabledState session_state;
    ...
    public LocalLBPoolMemberMemberSessionState(
           ...
           CommonEnabledState session_state) {
           this.member = member;
     ...
     */
    public CommonEnabledState getSession_state() {
        return session_state;
    }
     ...
     * @param session_state
     */
    public void setSession_state(CommonEnabledState session_state) {
        this.session_state = session_state;
    }
