...
public class SystemStatisticsGtmPathStatisticObjectID  implements java.io.Serializable {
    private SystemStatisticsGtmPathStatisticObjectType type;
    ...
    public SystemStatisticsGtmPathStatisticObjectID(
           SystemStatisticsGtmPathStatisticObjectType type,
           String name) {
           this.type = type;
           this.name = name;
    }
     ...
     * @return type
     */
    public SystemStatisticsGtmPathStatisticObjectType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(SystemStatisticsGtmPathStatisticObjectType type) {
        this.type = type;
    }
