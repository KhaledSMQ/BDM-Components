...
public class SystemCPUUsage  implements java.io.Serializable {
    ...
    public SystemCPUUsage(
           ...
           CommonULong64 user,
           CommonULong64 niced,
           CommonULong64 system,
           CommonULong64 idle,
           CommonULong64 irq,
           CommonULong64 softirq,
           CommonULong64 iowait) {
           this.cpu_id = cpu_id;
           this.user = user;
           this.niced = niced;
           this.system = system;
     ...
     * @param user
     */
    public void setUser(CommonULong64 user) {
        this.user = user;
    }
     ...
     * @param niced
     */
    public void setNiced(CommonULong64 niced) {
        this.niced = niced;
    }
     ...
     * @param system
     */
    public void setSystem(CommonULong64 system) {
        this.system = system;
    }
     ...
     * @param idle
     */
    public void setIdle(CommonULong64 idle) {
        this.idle = idle;
    }
     ...
     * @param irq
     */
    public void setIrq(CommonULong64 irq) {
        this.irq = irq;
    }
     ...
     * @param softirq
     */
    public void setSoftirq(CommonULong64 softirq) {
        this.softirq = softirq;
    }
     ...
     * @param iowait
     */
    public void setIowait(CommonULong64 iowait) {
        this.iowait = iowait;
    }
