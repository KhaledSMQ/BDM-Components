...
public class LocalLBVirtualServerVirtualServerResource  implements java.io.Serializable {
    private LocalLBVirtualServerVirtualServerType type;

    private String default_pool_name;

    public LocalLBVirtualServerVirtualServerResource() {
    }

    public LocalLBVirtualServerVirtualServerResource(
           LocalLBVirtualServerVirtualServerType type,
     ...
     * @return type
     */
    public LocalLBVirtualServerVirtualServerType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(LocalLBVirtualServerVirtualServerType type) {
        this.type = type;
    }
     ...
     */
    public String getDefault_pool_name() {
        return default_pool_name;
    }
     ...
     */
    public void setDefault_pool_name(String default_pool_name) {
        this.default_pool_name = default_pool_name;
    }
