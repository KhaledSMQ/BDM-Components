...
public class SystemStatisticsGtmIQueryState implements java.io.Serializable {
    ...
    // Constructor
    protected SystemStatisticsGtmIQueryState(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _IQUERY_STATE_UNCONNECTED = "IQUERY_STATE_UNCONNECTED";
    public static final String _IQUERY_STATE_CONNECTING = "IQUERY_STATE_CONNECTING";
    public static final String _IQUERY_STATE_CONNECTED = "IQUERY_STATE_CONNECTED";
    public static final String _IQUERY_STATE_BACKLOGGED = "IQUERY_STATE_BACKLOGGED";
    ...
    public static SystemStatisticsGtmIQueryState fromValue(String value)
    ...
    public static SystemStatisticsGtmIQueryState fromString(String value)
          throws IllegalArgumentException {
