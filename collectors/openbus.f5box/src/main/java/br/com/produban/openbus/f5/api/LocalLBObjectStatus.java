...
public class LocalLBObjectStatus  implements java.io.Serializable {
    private LocalLBAvailabilityStatus availability_status;

    private LocalLBEnabledStatus enabled_status;
    ...
    public LocalLBObjectStatus(
           LocalLBAvailabilityStatus availability_status,
           LocalLBEnabledStatus enabled_status,
     ...
     */
    public LocalLBAvailabilityStatus getAvailability_status() {
        return availability_status;
    }
     ...
     */
    public void setAvailability_status(LocalLBAvailabilityStatus availability_status) {
        this.availability_status = availability_status;
    }
     ...
     */
    public LocalLBEnabledStatus getEnabled_status() {
        return enabled_status;
    }
     ...
     */
    public void setEnabled_status(LocalLBEnabledStatus enabled_status) {
        this.enabled_status = enabled_status;
    }
