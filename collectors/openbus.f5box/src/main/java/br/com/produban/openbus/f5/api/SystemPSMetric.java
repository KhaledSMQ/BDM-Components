...
public class SystemPSMetric  implements java.io.Serializable {
    private SystemPSMetricType metric_type;
    ...
    public SystemPSMetric(
           SystemPSMetricType metric_type,
           long value) {
     ...
     * @return metric_type
     */
    public SystemPSMetricType getMetric_type() {
        return metric_type;
    }
     ...
     * @param metric_type
     */
    public void setMetric_type(SystemPSMetricType metric_type) {
        this.metric_type = metric_type;
    }
