...
public class LocalLBMonitorRule  implements java.io.Serializable {
    private LocalLBMonitorRuleType type;

    private long quorum;

    private String[] monitor_templates;

    public LocalLBMonitorRule() {
    }

    public LocalLBMonitorRule(
           LocalLBMonitorRuleType type,
           long quorum,
     ...
     * @param type
     */
    public void setType(LocalLBMonitorRuleType type) {
        this.type = type;
    }
     ...
     */
    public String[] getMonitor_templates() {
        return monitor_templates;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getMonitor_templates() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getMonitor_templates(), i);
                if (obj != null &&
