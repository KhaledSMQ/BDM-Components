...
public class SystemPlatformCPUs  implements java.io.Serializable {
     ...
     * @return cpus
     */
    public SystemCPUMetric[][] getCpus() {
        return cpus;
    }
     ...
     * @param cpus
     */
    public void setCpus(SystemCPUMetric[][] cpus) {
        this.cpus = cpus;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getCpus() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getCpus(), i);
                if (obj != null &&
