...
public class LocalLBPoolMemberMemberStatistics  implements java.io.Serializable {
    private LocalLBPoolMemberMemberStatisticEntry[] statistics;
    ...
    public LocalLBPoolMemberMemberStatistics(
           LocalLBPoolMemberMemberStatisticEntry[] statistics,
     ...
     * @return statistics
     */
    public LocalLBPoolMemberMemberStatisticEntry[] getStatistics() {
        return statistics;
    }
     ...
     * @param statistics
     */
    public void setStatistics(LocalLBPoolMemberMemberStatisticEntry[] statistics) {
        this.statistics = statistics;
    }
