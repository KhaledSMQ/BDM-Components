...
public class CommonStatistic  implements java.io.Serializable {
    private CommonStatisticType type;

    private CommonULong64 value;
     ...
     * @return type
     */
    public CommonStatisticType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(CommonStatisticType type) {
        this.type = type;
    }
     ...
     * @param value
     */
    public void setValue(CommonULong64 value) {
        this.value = value;
    }
