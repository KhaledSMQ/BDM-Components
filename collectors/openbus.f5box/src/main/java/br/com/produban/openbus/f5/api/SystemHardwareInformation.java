...
public class SystemHardwareInformation  implements java.io.Serializable {
    ...
    public SystemHardwareInformation(
           String name,
           SystemHardwareType type,
           long slot,
           String model,
           SystemVersionInformation[] versions) {
           this.name = name;
           this.type = type;
           this.slot = slot;
           this.model = model;
     ...
     * @param type
     */
    public void setType(SystemHardwareType type) {
        this.type = type;
    }
     ...
     * @param versions
     */
    public void setVersions(SystemVersionInformation[] versions) {
        this.versions = versions;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getVersions() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getVersions(), i);
                if (obj != null &&
