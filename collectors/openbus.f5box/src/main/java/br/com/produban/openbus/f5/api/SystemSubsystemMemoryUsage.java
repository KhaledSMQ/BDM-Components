...
public class SystemSubsystemMemoryUsage  implements java.io.Serializable {
    ...
    public SystemSubsystemMemoryUsage(
           ...
           CommonULong64 current_allocated,
           CommonULong64 maximum_allocated,
           CommonULong64 size) {
     ...
     */
    public void setCurrent_allocated(CommonULong64 current_allocated) {
        this.current_allocated = current_allocated;
    }
     ...
     */
    public void setMaximum_allocated(CommonULong64 maximum_allocated) {
        this.maximum_allocated = maximum_allocated;
    }
     ...
     * @param size
     */
    public void setSize(CommonULong64 size) {
        this.size = size;
    }
