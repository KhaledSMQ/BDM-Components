...
public class LocalLBPersistenceRecord  implements java.io.Serializable {
    ...
    private CommonIPPortDefinition node_server;

    private LocalLBPersistenceMode mode;

    private String persistence_value;

    private CommonVirtualServerDefinition virtual_server;
    ...
    public LocalLBPersistenceRecord(
           String pool_name,
           CommonIPPortDefinition node_server,
           LocalLBPersistenceMode mode,
           String persistence_value,
           CommonVirtualServerDefinition virtual_server,
           long create_time,
           long age) {
     ...
     * @return node_server
     */
    public CommonIPPortDefinition getNode_server() {
        return node_server;
    }
     ...
     * @param node_server
     */
    public void setNode_server(CommonIPPortDefinition node_server) {
        this.node_server = node_server;
    }
     ...
     * @return mode
     */
    public LocalLBPersistenceMode getMode() {
        return mode;
    }
     ...
     * @param mode
     */
    public void setMode(LocalLBPersistenceMode mode) {
        this.mode = mode;
    }
     ...
     */
    public CommonVirtualServerDefinition getVirtual_server() {
        return virtual_server;
    }
     ...
     */
    public void setVirtual_server(CommonVirtualServerDefinition virtual_server) {
        this.virtual_server = virtual_server;
    }
