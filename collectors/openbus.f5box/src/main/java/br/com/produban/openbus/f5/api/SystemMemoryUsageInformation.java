...
public class SystemMemoryUsageInformation  implements java.io.Serializable {
    ...
    public SystemMemoryUsageInformation(
           CommonULong64 total_memory,
           CommonULong64 used_memory,
           SystemSubsystemMemoryUsage[] usages,
     ...
     * @param total_memory
     */
    public void setTotal_memory(CommonULong64 total_memory) {
        this.total_memory = total_memory;
    }
     ...
     * @param used_memory
     */
    public void setUsed_memory(CommonULong64 used_memory) {
        this.used_memory = used_memory;
    }
     ...
     * @param usages
     */
    public void setUsages(SystemSubsystemMemoryUsage[] usages) {
        this.usages = usages;
    }
