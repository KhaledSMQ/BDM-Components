...
public class ManagementKeyCertificateCertificateInformation  implements java.io.Serializable {
    ...
    private ManagementKeyCertificateCertificateDetail certificate;
    ...
    public ManagementKeyCertificateCertificateInformation(
           boolean is_bundled,
           String file_name,
           ManagementKeyCertificateCertificateDetail certificate) {
     ...
     * @return certificate
     */
    public ManagementKeyCertificateCertificateDetail getCertificate() {
        return certificate;
    }
     ...
     * @param certificate
     */
    public void setCertificate(ManagementKeyCertificateCertificateDetail certificate) {
        this.certificate = certificate;
    }
