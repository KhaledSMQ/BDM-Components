...
public class LocalLBVirtualServerVirtualServerModuleScore  implements java.io.Serializable {
    private CommonTMOSModule tmos_module;
     ...
     * @return tmos_module
     */
    public CommonTMOSModule getTmos_module() {
        return tmos_module;
    }
     ...
     * @param tmos_module
     */
    public void setTmos_module(CommonTMOSModule tmos_module) {
        this.tmos_module = tmos_module;
    }
