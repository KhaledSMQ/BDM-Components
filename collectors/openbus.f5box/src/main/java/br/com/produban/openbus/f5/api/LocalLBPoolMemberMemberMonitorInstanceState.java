...
public class LocalLBPoolMemberMemberMonitorInstanceState  implements java.io.Serializable {
    ...
    private LocalLBMonitorInstanceState[] monitor_instances;
    ...
    public LocalLBPoolMemberMemberMonitorInstanceState(
           ...
           LocalLBMonitorInstanceState[] monitor_instances) {
           this.member = member;
     ...
     */
    public LocalLBMonitorInstanceState[] getMonitor_instances() {
        return monitor_instances;
    }
     ...
     */
    public void setMonitor_instances(LocalLBMonitorInstanceState[] monitor_instances) {
        this.monitor_instances = monitor_instances;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getMonitor_instances() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getMonitor_instances(), i);
                if (obj != null &&
