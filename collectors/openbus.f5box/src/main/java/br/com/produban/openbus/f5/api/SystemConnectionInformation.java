...
public class SystemConnectionInformation  implements java.io.Serializable {
    private CommonIPPortDefinition local;

    private CommonIPPortDefinition remote;

    public SystemConnectionInformation() {
    }

    public SystemConnectionInformation(
           CommonIPPortDefinition local,
           CommonIPPortDefinition remote) {
           this.local = local;
           this.remote = remote;
    }
     ...
     * @return local
     */
    public CommonIPPortDefinition getLocal() {
        return local;
    }
     ...
     * @param local
     */
    public void setLocal(CommonIPPortDefinition local) {
        this.local = local;
    }
     ...
     * @return remote
     */
    public CommonIPPortDefinition getRemote() {
        return remote;
    }
     ...
     * @param remote
     */
    public void setRemote(CommonIPPortDefinition remote) {
        this.remote = remote;
    }
