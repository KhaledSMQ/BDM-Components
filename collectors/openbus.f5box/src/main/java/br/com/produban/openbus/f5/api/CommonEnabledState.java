...
public class CommonEnabledState implements java.io.Serializable {
    ...
    // Constructor
    protected CommonEnabledState(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _STATE_DISABLED = "STATE_DISABLED";
    public static final String _STATE_ENABLED = "STATE_ENABLED";
    ...
    public static CommonEnabledState fromValue(String value)
    ...
    public static CommonEnabledState fromString(String value)
          throws IllegalArgumentException {
